...
# [FLAG apriltag-tag-size-2p5cm] AprilTag PnP translation scales directly with physical tag edge
...
class VisionAprilTagNode(Node):
    def __init__(self):
        ...
        # [FLAG apriltag-thread-safe-cache] The pose service may wait while the image callback is
        ...
        # [FLAG apriltag-camera-info-sub] Prefer live CameraInfo over stale hardcoded intrinsics so
    ...
    def _init_detector(self):
        # [FLAG apriltag-backend-select] Keep pupil_apriltags available because it detects the
    ...
    def _on_camera_info(self, msg: CameraInfo):
        # [FLAG apriltag-live-intrinsics] CameraInfo carries the intrinsics that match the current
    ...
    def detection_to_pose(self, detection, source_frame, source_stamp):
        ...
        # [FLAG apriltag-frame-safe-tf] Transform every service-visible pose into base_link. For this
    ...
    def _apply_base_transform(self, pose_camera, transform, source_frame):
        # [FLAG apriltag-pose-only-transform] In ROS Jazzy, do_transform_pose() transforms a plain
    ...
    def _project_detection_to_known_plane(self, base_pose, detection, transform):
        # [FLAG apriltag-known-plane-top-tags] For top-facing table tags, use the detected pixel
    ...
    def rotation_matrix_to_quaternion(self, R):
        ...
        # [FLAG apriltag-unit-quaternion] Normalize to prevent a nearly-correct rotation matrix
    ...
    def handle_get_tag_pose(self, request, response):
        ...
        # [FLAG apriltag-nonstarving-service] This callback may wait briefly for a fresh cached
...
def main(args=None):
    ...
    # [FLAG apriltag-multithreaded-spin] Use a multithreaded executor so service waits, image
