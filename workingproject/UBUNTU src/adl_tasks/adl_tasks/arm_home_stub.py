...
class ArmLookPoseStub(Node):
    ...
    def run(self) -> bool:
        ...
        # [FLAG look-pose-stub-joint-ready] Wait for the project MoveIt state topic before sending
        ...
        # [FLAG look-pose-stub-already-there] Skip a redundant MoveIt request when the arm is already
...
def _run_stub(target: str, args=None) -> None:
    ...
    # [FLAG look-pose-stub-spin-thread] MoveItHelper waits on ROS action/service futures, so keep the
