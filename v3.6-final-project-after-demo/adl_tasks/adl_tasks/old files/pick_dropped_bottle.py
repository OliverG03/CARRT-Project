...
class PickDroppedBottle(Node):
    ...
    def command_callback(self, msg):
        ...
        if cmd == "stop_task" and self.base.executing:
            # [FLAG shared-stop-command] Graceful stop is handled task-locally via cancellation. The shared
            # ADL controller owns the later retract park once this task reports IDLE.
    ...
    def execute_task(self):
        ...
        self.get_logger().info("Task completed. Shared controller will park the arm on IDLE.")
